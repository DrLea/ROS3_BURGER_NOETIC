...
class GPUStatus {
  ...
  static getMessageSize(object) {
    ...
    length += _getByteLength(object.product_name);
    length += _getByteLength(object.pci_device_id);
    length += _getByteLength(object.pci_location);
    length += _getByteLength(object.display);
    length += _getByteLength(object.driver_version);
    return length + 36;
  }
