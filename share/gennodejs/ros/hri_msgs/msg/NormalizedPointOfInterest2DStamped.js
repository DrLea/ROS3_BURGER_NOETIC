...
class NormalizedPointOfInterest2DStamped {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new NormalizedPointOfInterest2DStamped(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new NormalizedPointOfInterest2DStamped(null);
...
module.exports = NormalizedPointOfInterest2DStamped;
