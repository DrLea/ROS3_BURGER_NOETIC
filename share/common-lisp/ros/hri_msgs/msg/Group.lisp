...
(cl:defmethod cl:initialize-instance :after ((m <Group>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Group)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hri_msgs-msg:<Group> is deprecated: use hri_msgs-msg:Group instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Group>))
...
(cl:defmethod group_id-val ((m <Group>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hri_msgs-msg:group_id-val is deprecated.  Use hri_msgs-msg:group_id instead.")
  (group_id m))

(cl:ensure-generic-function 'members-val :lambda-list '(m))
(cl:defmethod members-val ((m <Group>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hri_msgs-msg:members-val is deprecated.  Use hri_msgs-msg:members instead.")
  (members m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Group>)))
  ...
  "76be953e6ddf78f60b879c220d0a3c32")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Group)))
  "Returns md5sum for a message object of type 'Group"
  "76be953e6ddf78f60b879c220d0a3c32")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Group>)))
  ...
  (cl:format cl:nil "Header header~%~%string group_id~%~%# List of person IDs of the people in this group~%string[] members~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Group)))
  "Returns full string definition for message of type 'Group"
  (cl:format cl:nil "Header header~%~%string group_id~%~%# List of person IDs of the people in this group~%string[] members~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
