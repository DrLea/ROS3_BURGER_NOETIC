...
(cl:defclass <DockActionGoal> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (goal
    :reader goal
    :initarg :goal
    :type py_trees_msgs-msg:DockGoal
    :initform (cl:make-instance 'py_trees_msgs-msg:DockGoal)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <DockActionGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DockActionGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name py_trees_msgs-msg:<DockActionGoal> is deprecated: use py_trees_msgs-msg:DockActionGoal instead.")))
