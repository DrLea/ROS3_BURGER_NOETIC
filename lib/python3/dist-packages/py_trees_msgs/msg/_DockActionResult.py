...
"""autogenerated by genpy from py_trees_msgs/DockActionResult.msg. Do not edit."""
import codecs
import sys
...
class DockActionResult(genpy.Message):
  ...
  _type = "py_trees_msgs/DockActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','py_trees_msgs/DockResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = py_trees_msgs.msg.DockResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = py_trees_msgs.msg.DockResult()
