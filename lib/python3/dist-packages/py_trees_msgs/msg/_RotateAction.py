...
"""autogenerated by genpy from py_trees_msgs/RotateAction.msg. Do not edit."""
import codecs
import sys
...
class RotateAction(genpy.Message):
  _md5sum = "c68d9e0a719660a32868a081a56942db"
  _type = "py_trees_msgs/RotateAction"
...
"""
  ...
  _slot_types = ['py_trees_msgs/RotateActionGoal','py_trees_msgs/RotateActionResult','py_trees_msgs/RotateActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = py_trees_msgs.msg.RotateActionGoal()
      if self.action_result is None:
        self.action_result = py_trees_msgs.msg.RotateActionResult()
      if self.action_feedback is None:
        self.action_feedback = py_trees_msgs.msg.RotateActionFeedback()
    else:
      self.action_goal = py_trees_msgs.msg.RotateActionGoal()
      self.action_result = py_trees_msgs.msg.RotateActionResult()
      self.action_feedback = py_trees_msgs.msg.RotateActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_result.result.value
      buff.write(_get_struct_b().pack(_x))
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_2f().pack(_x.action_feedback.feedback.percentage_completed, _x.action_feedback.feedback.angle_rotated))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.action_result.result.value,) = _get_struct_b().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_feedback.feedback.percentage_completed, _x.action_feedback.feedback.angle_rotated,) = _get_struct_2f().unpack(str[start:end])
      return self
