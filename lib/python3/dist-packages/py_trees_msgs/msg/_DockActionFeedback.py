...
"""autogenerated by genpy from py_trees_msgs/DockActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class DockActionFeedback(genpy.Message):
  ...
  _type = "py_trees_msgs/DockActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','py_trees_msgs/DockFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = py_trees_msgs.msg.DockFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = py_trees_msgs.msg.DockFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.feedback.percentage_completed
