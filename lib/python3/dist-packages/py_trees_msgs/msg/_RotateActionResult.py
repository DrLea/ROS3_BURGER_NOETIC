...
"""autogenerated by genpy from py_trees_msgs/RotateActionResult.msg. Do not edit."""
import codecs
import sys
...
class RotateActionResult(genpy.Message):
  _md5sum = "4eda63f75c02197dafd2a62a0d413ab0"
  _type = "py_trees_msgs/RotateActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','py_trees_msgs/RotateResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = py_trees_msgs.msg.RotateResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = py_trees_msgs.msg.RotateResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.value,) = _get_struct_b().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
