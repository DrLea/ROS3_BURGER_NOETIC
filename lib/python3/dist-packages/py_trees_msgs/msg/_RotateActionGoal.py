...
"""autogenerated by genpy from py_trees_msgs/RotateActionGoal.msg. Do not edit."""
import codecs
import sys
...
class RotateActionGoal(genpy.Message):
  ...
  _type = "py_trees_msgs/RotateActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','py_trees_msgs/RotateGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.goal is None:
        self.goal = py_trees_msgs.msg.RotateGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = py_trees_msgs.msg.RotateGoal()
