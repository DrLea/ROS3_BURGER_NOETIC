...
"""autogenerated by genpy from hri_msgs/Gesture.msg. Do not edit."""
import codecs
import sys
...
class Gesture(genpy.Message):
  _md5sum = "c64cc745a3c18d0a7abe6aed5be4f345"
  _type = "hri_msgs/Gesture"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """# Describes body language/attitude/gesture detected from a body.
Header header
...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.gesture,) = _get_struct_B().unpack(str[start:end])
      return self
