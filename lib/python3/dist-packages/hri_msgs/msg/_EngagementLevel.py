...
"""autogenerated by genpy from hri_msgs/EngagementLevel.msg. Do not edit."""
import codecs
import sys
...
class EngagementLevel(genpy.Message):
  _md5sum = "98693df082bea7da40fa598b187373d9"
  _type = "hri_msgs/EngagementLevel"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """# Discrete engagement levels of a person with respect to the robot
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(EngagementLevel, self).__init__(*args, **kwds)
