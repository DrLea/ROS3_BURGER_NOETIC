...
struct State_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::rosmon_msgs::NodeState_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::rosmon_msgs::NodeState_<ContainerAllocator> >> _nodes_type;
  _nodes_type nodes;
